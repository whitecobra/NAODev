...
if(NOT "/home/developer/catkin_ws/devel/include;/home/developer/catkin_ws/src/beginner_tutorials/include" STREQUAL "")
  set(beginner_tutorials_INCLUDE_DIRS "")
  set(_include_dirs "/home/developer/catkin_ws/devel/include;/home/developer/catkin_ws/src/beginner_tutorials/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'S. Luetkemeier <whitecobra@gmx.net>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/catkin_ws/src/beginner_tutorials/${idir}'.  Ask the maintainer 'S. Luetkemeier <whitecobra@gmx.net>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/developer/catkin_ws/devel/lib;/home/developer/catkin_ws/devel/lib;/opt/ros/indigo/lib)
